                    ...
                    <form class="flex flex-wrap flex-col mb-5" method="post" enctype="multipart/form-data"
                        ...
                        <textarea
                            ...
                            <div class="w-full my-2">
                                ...
                                <input type="number" name="qty" class="w-full h-10 my-2 border rounded-lg" value="{{ $lot->qty }}">
                        ...
                        <div class="w-full my-2">
                            ...
                            <input type="datetime-local" name="start_time" class="w-full h-10 my-2 border rounded-lg" value="{{ $lot->end_time }}">
