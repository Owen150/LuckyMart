                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form class="flex flex-wrap" method="post" action="{{route('lots.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="w-full my-2">
                            ...
                            <input type="number" name="qty" class="w-full h-10 my-2 border rounded-lg" value="0">
                        ...
                        <div class="w-full my-2">
                            ...
                            <input type="datetime-local" name="start_time" class="w-full h-10 my-2 border rounded-lg">
